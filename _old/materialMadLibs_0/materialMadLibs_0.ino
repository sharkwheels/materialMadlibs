...
#include "pitches.h"
const int buttonNo = 2;
const int buttonYes = 3;
const int buttonSurprise = 4;

const int ledNo =  13;      
const int ledYes = 12;
const int ledSurprise = 11;
...
void setup() {
  ...
  pinMode(buttonNo, INPUT_PULLUP);  // don't use a pull down on this. 
...
void loop() {
  ...
  int reading = digitalRead(buttonNo);
